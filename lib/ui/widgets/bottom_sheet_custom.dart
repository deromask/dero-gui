...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  _ModalBottomSheetLayout(this.progress, double maxHeightFactor)
      : this.maxHeightFactor =
            (maxHeightFactor == null) ? (9.0 / 16.0) : maxHeightFactor;
...
//    print("maxHeightFactor: " + maxHeightFactor.toString());
    return BoxConstraints(
      minWidth: constraints.maxWidth,
      maxWidth: constraints.maxWidth,
      minHeight: 0.0,
      maxHeight:
          constraints.maxHeight * maxHeightFactor, //todo [change] [patch]
    );
  }
            ...
            child: ClipRect(
              child: CustomSingleChildLayout(
                delegate: _ModalBottomSheetLayout(
                    animationValue, widget.route.maxHeightFactor),
                child: BottomSheet(
                  animationController: widget.route._animationController,
                  onClosing: () => Navigator.pop(context),
                  builder: (context) {
//                    print('route.color: ' + widget.route.color.toString());
                    return Container(
...
Future<T> showModalBottomSheetCustom<T>({
  ...
  double radius: 10.0,
  double maxHeightFactor: 9.0 / 16.0,
